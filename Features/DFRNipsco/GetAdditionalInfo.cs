...
{
    public class GetNipscoDFRAdditionalInfo
    {
        public class ResponseData : CrewlinkServices.Features.DailyActivity.DFRNipsco.GetAdditionalInfo.Response
        {
        ...
        public static void GetCommonSection(long ActivityId, ResponseData response, int DfrId)
        {
            using (var _context = new ApplicationContext())
            {
                ...
                response.AdditionalInfo = result.GroupBy(x => new { x.Name, x.DisplayOrder })
