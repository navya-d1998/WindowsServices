...
{
    public class GetPngDFRAdditionalInfo
    {
        public class ResponseData : CrewlinkServices.Features.DailyActivity.DFRPng.GetAdditionalInfo.Response
        {
        ...
        public static void GetAdditionalInfo(long activityId, ResponseData response, int dfrId)
        {
            ...
            {
                var additionalInputPng = (from infomaster in _context.Get<DfrAdditionalInfoMaster>()
                ...
                response.AdditionalInfo = additionalInputPng.GroupBy(x => new { x.Name })
