...
{
    public class GetWglVaBlanketDFRAdditionalInfo
    {
        public class ResponseData : CrewlinkServices.Features.DailyActivity.DFRWglVaBlanket.GetAdditionalInfo.Response
        {
